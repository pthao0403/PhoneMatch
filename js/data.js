...
const products = [
  {
    ...
    charging: "USB-C",
    os: "iOS",
    needs: ["camera", "daily", "student"],
    source: "Apple Việt Nam",
    sourceUrl: "https://www.apple.com/vn/iphone-17/specs/",
    description:
      "iPhone 17 hướng tới người dùng cần một máy cao cấp, màn hình 120Hz và hệ sinh thái iOS."
  },

  {
    ...
    os: "Android / One UI",
    needs: ["camera", "gaming", "daily"],
    source: "Samsung Việt Nam",
    sourceUrl: "https://www.samsung.com/vn/smartphones/galaxy-s26/specs/",
    description:
      "Galaxy S26 là smartphone flagship nhỏ gọn với camera đa tiêu cự, 12GB RAM và pin 4300mAh."
  },

  {
    ...
    charging: "Sạc nhanh có dây / không dây",
    os: "Android / One UI",
    needs: ["camera", "gaming", "power"],
    source: "Samsung Việt Nam",
    sourceUrl: "https://www.samsung.com/vn/smartphones/galaxy-s26/",
    description:
      "Galaxy S26 Ultra tập trung vào camera, màn hình lớn, hiệu năng flagship và nhu cầu sử dụng chuyên sâu."
  },

  {
    ...
    description:
      "Xiaomi 15 kết hợp thiết kế nhỏ gọn với Snapdragon 8 Elite, 12GB RAM, 512GB và sạc 90W."
  },

  {
    ...
    os: "Xiaomi HyperOS",
    needs: ["gaming", "daily", "power"],
    source: "Xiaomi Việt Nam",
    sourceUrl: "https://www.mi.com/vn/product/xiaomi-15t/specs/",
    description:
      "Xiaomi 15T có màn hình lớn 120Hz, 12GB RAM và chip Dimensity 8400-Ultra."
  },

  {
    ...
    camera:
      "50MP chính + 8MP Ultra Wide + 2MP Mono; selfie 50MP",
    battery: "5600mAh",
    charging: "80W SUPERVOOC",
    os: "ColorOS 15",
    needs: ["camera", "student", "daily"],
    source: "OPPO Việt Nam",
    sourceUrl:
      "https://www.oppo.com/vn/smartphones/series-reno/reno13/specs/",
    description:
      "Reno13 5G thiên về camera, thiết kế mỏng nhẹ, pin 5600mAh và sạc nhanh 80W."
  },

  {
    ...
    camera:
      "Camera chính độ phân giải cao + camera góc siêu rộng",
    battery: "5800mAh",
    charging: "45W SUPERVOOC",
    os: "ColorOS",
    needs: ["student", "daily", "battery"],
    source: "OPPO Việt Nam",
    sourceUrl:
      "https://www.oppo.com/vn/smartphones/series-reno/reno13-f-4g/",
    description:
      "Reno13 F 4G tập trung vào thời lượng pin, màn hình 120Hz và nhu cầu sử dụng hằng ngày."
  }
];
